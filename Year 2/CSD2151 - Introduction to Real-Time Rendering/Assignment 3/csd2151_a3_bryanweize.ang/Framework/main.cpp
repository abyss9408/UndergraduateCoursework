...
// Global variables for the reset state and start time
...
int main(int argc, char** argv)
{
    ...
    std::cout << std::endl;
    std::cout << "Curved object visualization" << std::endl;
    std::cout << "- The fragment shader implements a sphere using ray-sphere intersection mathematics" << std::endl;
    std::cout << "Dynamic color changes" << std::endl;
	std::cout << "- Time-based color changes for the sphere" << std::endl;
	std::cout << "Light-based shading" << std::endl;
	std::cout << "- The fragment shader implements diffuse lighting in rayTracing() function" << std::endl;
	std::cout << "- Light position is static at vec3(10.0f, 10.0f, 10.0f)" << std::endl;
    std::cout << "Dynamic position" << std::endl;
    std::cout << "- Animated sphere position using sine/cosine" << std::endl;
    std::cout << "Reset functionality" << std::endl;
    std::cout << "- Reset functionality with 'R' key" << std::endl;
    std::cout << std::endl;
            ...
            // Rendering passes
            {
                // Pass 0
                {
                    ...
                    [](cg::Program& shader)
                    {
                        ...
                        shader.setUniform("iTime", (float)glfwGetTime() - startTime);
                        shader.setUniform("resetState", resetState);
                    }
                }
            }
        };
